...
export async function createAdminToken(payload: Record<string, any> = {}, expiresInSeconds = 7200): Promise<string> {
  ...
  const fullPayload = {
    ...
    ...payload,
    iat: now,
    exp: now + expiresInSeconds, // 2 hours default (7200 seconds)
  };
